...
import com.baway.admin.dongjinjinjongdongapp.Payactivity;
...
public class Fragment4 extends Fragment implements View.OnClickListener, view.View, View_A {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=View.inflate(getActivity(), R.layout.frag4,null);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.bianji:
                ...
                break;
            case R.id.tv_delete:
                Toast.makeText(getActivity(),"真的点击了删除吗？",Toast.LENGTH_SHORT).show();
            ...
            case R.id.tv_go_to_pay:
                ...
                System.out.println(uid+"=======uiduiduid======"+s);
