...
public class ShopOneAdapter extends RecyclerView.Adapter<ShopOneAdapter.ShopOneViewHolder> {
    ...
    public void onBindViewHolder(final ShopOneViewHolder holder, final int position) {
        ...
        List<CX.DataBean.ListBean> list = this.list.get(position).getList();
        final ShopTwoAdapter shopTwoAdapter=new ShopTwoAdapter(list,context);
        ...
        shopTwoAdapter.setAa(new ShopTwoAdapter.AA() {
            ...
            public void Success(int i) {
                System.out.println("==="+i+"=="+ ShopOneAdapter.this.list.get(position).getList().size());
                if(i== ShopOneAdapter.this.list.get(position).getList().size()){
                    holder.fu_chekbox.setChecked(true);
                    flag[position]=true;
